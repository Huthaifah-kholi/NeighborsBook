...
<div class="col-md-6 col-md-offset-3">
    ...
    <form action="{{ url('addpickneed') }}" method="post" accept-charset="utf-8" class="form"  role="form" id="myform" enctype="multipart/form-data"> 
              {!! csrf_field() !!}
            <h4 style="color: black; margin: initial; margin-bottom: 10px;">Publish your needs To Your Neighbors </h4><hr>
            ...
            <div class="input-group margin-bottom-20">
                ...
                <select class="form-control" name="cat">
                    ...
                    <option value="Computer">Bocks</option>
                    <option value="Clothing">Clothing</option>
                    <option value="Beauty">Beauty &amp; Healthcare</option>
                    <option value="Babies">Toys, Kids &amp; Babies</option>
